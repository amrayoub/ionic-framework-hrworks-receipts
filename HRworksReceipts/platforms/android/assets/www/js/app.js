...
.run(function($localstorage, Friends, KindsOfPayment, Currencies, ReceiptKinds) {
	$localstorage.setObject('receipts', Friends.all());
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('tab.updateReceipts', {
      url: '/updateReceipts',
      views: {
        'updateReceipts': {
          templateUrl: 'templates/updateReceipts.html',
          controller: 'updateReceiptsCtrl'
        }
      }
    })
    .state('tab.addReceipts', {
		url: '/addReceipts',
		templateUrl: 'templates/addReceipts.html',

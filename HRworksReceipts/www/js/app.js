...
.config(function ($translateProvider) {
	...
	$translateProvider.translations('de', {
		...
		GERMAN : 'Deutsch',
		INFOS : 'Infos',
		INFOS_ANDROID_TEXT : 'Sollte beim Feld "Datum" in der Belegerfassung keine Auswahl erscheinen oder die Tastatur für die Betragseingabe keinen Punkt/Komma zur Verfügung stellen, aktivieren Sie das Feld "alternative Datumsauswahl" bzw. "alternative Betragseingabe" in den Einstellungen.',
